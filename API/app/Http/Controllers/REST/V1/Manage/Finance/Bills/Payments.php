...
class Payments extends BaseREST
{
    ...
    {
        // Kita perlu mengambil objek bill di sini untuk diteruskan ke DBRepo
        $bill = \App\Models\bill::find($this->payload['id']);

        $dbRepo = new DBRepo($this->payload, $this->file, $this->auth);
        $insert = $dbRepo->insertPayment($bill, $this->payload);
